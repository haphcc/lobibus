...
<div class="admin-card">
    <table class="table table-striped align-middle">
        <thead><tr><th>Mã đơn</th><th>Khách hàng</th><th>Tuyến</th><th>Giờ đi</th><th>Tổng tiền</th><th>Đặt vé</th><th>Phương thức thanh toán</th><th class="text-end">Thao tác</th></tr></thead>
        <tbody>
        <?php foreach ($bookings as $booking): ?>
            <tr>
                ...
                <td><?= e(admin_label($booking['payment_method'] ?? '-')) ?></td>
